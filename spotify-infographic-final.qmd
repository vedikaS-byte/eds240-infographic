...
![](images/Anatomy%20of%20Spotify%20Hit%20Infographic%20(3).png)
...
I also decided to exlude "gaming" as a playlist genre because it represents a Spotify playlist type rather than a specific genre; its tracks laregely overlap with pop, hip-hop, and R&B, which are already captured elsewhere in their respective genres.

The results indicate stark contrasts across genres. Pop has about 80% of its songs classified as hits, followed by rock at about 74%. World, lofi, and jazz have the least percentage of hit songs in their respective genres. Genre is likely a strong factor in determining a song's success, as pop or rock songs have a substantially higher baseline probability of becoming hits compared to those in lofi or ambient categories.
...
The infographic is supported by Spotify’s signature green (`#1DB954`) on a near-black background (`#2b2b2b`) to better signla the subject matter without explicitly labeling that the infographic relates to Spotify data. Green consistently encodes “popular” or “high” across all three plots, allowing readers to quickly build a visual intuition. White represents low popularity throughout, establishing a clear and consistent two-color visual language. I also verified that the green-on-dark contrast meets accessibility standards for readability.
...
Is there a dicernible recipe for a Spotify hit? The data suggests that there may be to some degree. Popular songs tend to be loud, energetic, and danceable. Genre also seems to be a strong factor in influencing a song's popularity likelihood. Pop and rock songs have a higher likelihood of achieving popularity, whereas "calmer" genres (ex. lofi and jazz) face more of a challenge to reach popularity. The contour plot clearly outlined that high-popularity songs form a notably tight cluster, indicating that hits don’t just share a few traits but also they occupy a very specific region of this sonic feature space.
...
Icons are derived from icons8.com.

-   `<a target="_blank" href="https://icons8.com/icon/MlGSWD5FCHqv/microphone"`{=html}Microphone</a> icon by `<a target="_blank" href="https://icons8.com"`{=html}Icons8</a>

-   `<a target="_blank" href="https://icons8.com/icon/11076/rock-music"`{=html}electric guitar</a> icon by `<a target="_blank" href="https://icons8.com"`{=html}Icons8</a>

-   `<a target="_blank" href="https://icons8.com/icon/fzTNjNsM9oYv/rap"`{=html}Rap</a> icon by `<a target="_blank" href="https://icons8.com"`{=html}Icons8</a>

-   `<a target="_blank" href="https://icons8.com/icon/a8hPL12leqi4/dancing"`{=html}Dancing</a> icon by `<a target="_blank" href="https://icons8.com"`{=html}Icons8</a>

-   `<a target="_blank" href="https://icons8.com/icon/11144/electronic-music"`{=html}Electronic Music</a> icon by `<a target="_blank" href="https://icons8.com"`{=html}Icons8</a>

-   `<a target="_blank" href="https://icons8.com/icon/11404/moon-and-stars"`{=html}Moon and Stars</a> icon by `<a target="_blank" href="https://icons8.com"`{=html}Icons8</a>

-   `<a target="_blank" href="https://icons8.com/icon/9313/sun"`{=html}Sun</a> icon by `<a target="_blank" href="https://icons8.com"`{=html}Icons8</a>

-   `<a target="_blank" href="https://icons8.com/icon/84635/earth-planet"`{=html}Earth</a> icon by `<a target="_blank" href="https://icons8.com"`{=html}Icons8</a>

-   `<a target="_blank" href="https://icons8.com/icon/f6N0ObuRcP91/listening-to-music-on-headphones"`{=html}Listening To Music On Headphones</a> icon by `<a target="_blank" href="https://icons8.com"`{=html}Icons8</a>

-   `<a target="_blank" href="https://icons8.com/icon/24854/jazz"`{=html}Jazz</a> icon by `<a target="_blank" href="https://icons8.com"`{=html}Icons8</a>
